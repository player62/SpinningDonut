...
while running:
    ...
    for theta in range(0, 800, theta_spacing):  # theta goes around the cross-sectional circle of a torus, from 0 to 2pi
        for phi in range(0, 800, phi_spacing):  # phi goes around the center of revolution of a torus, from 0 to 2pi
